...
const AddDoctor = () => {
  ...
  const imageStorageKey = '0eac0e5ec3b2cfe691f1bd4a32034dd1'
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-control w-full max-w-xs">
          <label htmlFor="img" className="bg-slate-300  flex justify-center items-center py-2">
           <span>Upload image</span><BsFillImageFill className="text-5xl"/>
          </label>
          <input
          id="img"
            type="file"
